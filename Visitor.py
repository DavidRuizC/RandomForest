...
# We use the design pattern "VISITOR", which allow us to create the different functions that we want to implement as
# classes, and after that, the whole tree will visit them both.

# The advantage of this implementation is that, if in the future we want to add new functions to the tree, we can just
# add new classes that inherit the abstract "Visitor" one.
