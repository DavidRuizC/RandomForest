...
class Parent(Node):
    ...
    def accept_visitor(self, visitor):
        # For the type hints we should say that visitor is from class Visitor but if we do so, it appears a problem of
        # circular importation with Visitor file, so we can
